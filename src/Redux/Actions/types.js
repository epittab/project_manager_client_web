...
export const GENERAL_CLEANUP = 'GENERAL_CLEANUP';

//EditUser
export const FETCH_USER_DETAILS = 'FETCH_USER_DETAILS';
export const CHANGE_USER_COST = 'CHANGE_USER_COST';
export const TOGGLE_USER = 'TOGGLE_USER';
export const TOGGLE_USER_COST = 'TOGGLE_USER_COST';
export const CLEANUP_USER = 'CLEANUP_USER';
export const CLEANUP_USER_COST = 'CLEANUP_USER_COST';
export const CHANGE_USER = 'CHANGE_USER';
export const PATCH_USER_COST_FORM = 'PATCH_USER_COST_FORM';
export const USER_COST_SUCCESS = 'USER_COST_SUCCESS';

export const PATCH_USER_FORM = 'PATCH_USER_FORM';
export const USER_SUCCESS = 'USER_SUCCESS';

//Invites
export const FETCH_ALL_CONTRIBUTORS = 'FETCH_ALL_CONTRIBUTORS';
export const INVITE_FORM_CLEANUP = 'USER_SUCCESS';
export const CHANGE_INVITE_FORM = 'CHANGE_INVITE_FORM';
